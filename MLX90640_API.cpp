...
void MLX90640_CalculateTo(uint16_t *frameData, const paramsMLX90640 *params, float emissivity, float tr, float *result)
{
    ...
    ta4 = (ta + 273.15) * (ta + 273.15);
    //ta4 = ta4 * ta4;
    tr4 = (tr + 273.15) * (tr + 273.15);
    tr4 = tr4 * tr4; 
    taTr = tr4 - (tr4 - ta4 * ta4) / emissivity;
...
//------------------------- To calculation -------------------------------------    
    ...
    irDataCP[0] = irDataCP[0] - params->cpOffset[0] * (1 + params->cpKta * ta) * (1 + params->cpKv * vdd);
    if( mode ==  params->calibrationModeEE)
    {
        irDataCP[1] = irDataCP[1] - params->cpOffset[1] * (1 + params->cpKta * ta) * (1 + params->cpKv * vdd);
    }
    else
    {
      irDataCP[1] = irDataCP[1] - (params->cpOffset[1] + params->ilChessC[0]) * (1 + params->cpKta * ta) * (1 + params->cpKv * vdd);
    }
    ...
    for( int pixelNumber = 0; pixelNumber < 768; pixelNumber++)
    {
        ...
        //conversionPattern = ((pixelNumber + 2) * 0.25 - (pixelNumber + 3) * 0.25 + (pixelNumber + 1) * 0.25 - pixelNumber * 0.25) * (1 - 2 * ilPattern);
        //ilPattern = 0; 
        //chessPattern = ilPattern ^ 0; 
        //conversionPattern = 0;
/*
        if(mode == 0)
        {
...
*/        
        ...
        {    
            ...
            irData = irData - params->offset[pixelNumber]*(1 + params->kta[pixelNumber]*ta)*(1 + params->kv[pixelNumber]*vdd);
            /*if(mode !=  params->calibrationModeEE)
            {
            ...
            irData = irData / emissivity - params->tgc * irDataCP[subPage];

            alphaCompensated = (params->alpha[pixelNumber] - params->tgc * params->cpAlpha[subPage])*(1 + params->KsTa * ta);
...
void MLX90640_GetImage(uint16_t *frameData, const paramsMLX90640 *params, float *result)
{
    ...
    subPage = frameData[833];
    vdd = MLX90640_GetVdd(frameData, params) - 3.3;
    ta = MLX90640_GetTa(frameData, params) - 25;
...
float MLX90640_GetTa(uint16_t *frameData, const paramsMLX90640 *params)
{
    ...
    ptatArt = (ptat / (ptat * params->alphaPTAT + ptatArt)) * 262144;
